...
class GovernanceGateTests(unittest.TestCase):
    ...
    def test_promotion_freezes_when_multiple_testing_is_not_promotable(self) -> None:
        state = {
            "approvals": {"frozen_spec_approval": True},
            "audit_summary": {
                "leakage": "pass",
    ...
    def test_promotion_freezes_when_random_signal_plumbing_fails(self) -> None:
        state = {
            "approvals": {"frozen_spec_approval": True},
            "audit_summary": {
                "leakage": "pass",
                ...
                "overfitting": "pass",
                "multiple_testing": {"status": "pass", "promotable_method": True},
                "random_signal_plumbing": {"status": "fail"},
                "model_diagnostics": {"calibration_review": {"status": "pass"}},
            },
            "search_results": {"best_trial": {"net_avg_pnl_r": 0.1}},
            "translation_summary": {"status": "pass"},
