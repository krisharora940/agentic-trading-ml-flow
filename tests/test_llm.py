...
class LLMTests(unittest.TestCase):
    def test_default_model_uses_explicit_override(self) -> None:
        with mock.patch.dict(os.environ, {"TRADING_ML_MODEL": "ollama:qwen2.5:14b-instruct"}, clear=False):
    ...
    def test_create_chat_model_uses_ollama_compatible_defaults(self) -> None:
        ...
        with mock.patch.dict(os.environ, env, clear=True):
            with mock.patch("langchain_openai.ChatOpenAI", return_value=fake) as chat_model:
